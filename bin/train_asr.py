...
class Solver(BaseSolver):
    ...
    def __init__(self, config, paras, mode):
        ...
        # Curriculum learning(课程学习) affects data loader
    ...
    def set_model(self):
        ...
        # 注意CTC loss : https://pytorch.org/docs/stable/generated/torch.nn.CTCLoss.html#torch.nn.CTCLoss
    ...
    def exec(self):
        ...
        while self.step < self.max_step:
            ...
            # ===================================== 训练部分 ===========================================
            # data:(file<str or int?>, audio_feat<tensor>, audio_len, text<tensor>)
